...
const UserDetails = () => {
    ...
    const handleGetOneUserData = () => {
        const url = `https://n1-finance-back-end.vercel.app/api/userdata/${id}`;
        axios
            .get(url)
            .then((res) => {
    ...
    const AddProfit = () => {
        const url = `https://n1-finance-back-end.vercel.app/api/add-profit/${id}`;
    ...
    const handleLogin = () => {
        ...
        setTimeout(() => {
            ...
            window.location.href = `https://n1-finance-dasoard.vercel.app/#/dashboard/${userId}`;
        }, 3000);
        setShowActions(false);
